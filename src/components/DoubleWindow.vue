...
const height = computed(() => {
  return measurement.value.borderT + measurement.value.glassY + measurement.value.borderB
})
...
<template>
  <div class="flex flex-row items-start gap-4">
    <div class="flex flex-col items-center gap-4">
      ...
      >
        <div
          class="border border-black h-full bg-cover bg-no-repeat bg-center"
